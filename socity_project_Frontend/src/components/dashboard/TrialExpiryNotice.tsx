...
const upgradePlans = [
  {
    ...
    numericPrice: 499,
    period: 'per month',
    description: 'Digital gate QR scan & basic maintenance invoicing.',
    features: ['Digital Gate QR Scan Entry', 'Resident Directory & My Unit', 'Basic Maintenance Invoicing', 'Complaint & Helpdesk Tickets'],
    isPopular: false,
  },
  {
    name: 'Basic Plan',
    ...
    numericPrice: 1299,
    period: 'per month',
    description: 'Complete resident, vehicle & maid attendance.',
    features: ['Complete Resident & Security Access', 'Vehicle Parking QR Stickers', 'Domestic Staff / Maid Attendance', 'Automated Dues & Payment Receipts'],
    isPopular: false,
  },
  {
    name: 'Pro Plan',
    ...
    numericPrice: 1999,
    period: 'per month',
    description: 'Advanced accounting, ledger & local vendor matching.',
    features: ['All Basic Plan Features Included', 'Advanced Accounting & Bank Ledger', 'Local Vendor & Service Auto-Matching', 'Amenity & Facility Booking System'],
    isPopular: true,
  },
  {
    name: 'Professional',
    ...
    numericPrice: 4999,
    period: 'per month',
    description: 'Full double-entry accounting & dedicated manager.',
    features: ['All Pro Plan Features Included', 'Full Double-Entry Society Accounting', 'B2C Individual Client Management', 'Dedicated Account Manager (24/7)'],
    isPopular: false,
  },
]
...
export function TrialExpiryNotice({ daysLeft = 2, planName = '7-Day Free Trial' }: TrialExpiryNoticeProps) {
  ...
  const isFullyExpired = (createdTime !== null && daysElapsed >= totalDaysInPeriod) || (createdTime !== null && actualDaysLeft === 0)
